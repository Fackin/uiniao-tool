<template>
  <div class="bg-gradient max-w-6xl mx-auto">
    <h1 class="text-xl font-bold mb-4 drop-shadow-sm">工具</h1>
    ...
    <div v-for="category in filteredCategories" :key="category.id" class="mb-8">
      ...
      >
        ...
        >
          ...
          >
            <component v-if="site.icon" :is="site.icon" class="w-5 h-5" />
