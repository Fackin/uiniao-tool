<template>
  ...
  <div
    class="keyboard-container bg-gray-200 p-4 rounded-lg shadow-lg flex gap-2 text-black"
  >
    <div>
      <!-- Function Keys Row -->
      <div class="flex gap-1 mb-2">
        <template v-for="key in layouts.functionKeys">
          ...
          <div v-if="key === 'F4-aft' || key === 'F8-aft'" class="w-[18px]"></div>
          <div
      ...
      <div class="flex gap-1 mb-2">
        ...
        <div
          ...
          :key="key"
          :class="['key', { active: pressedKeys.includes(key), 'slash-key': key === '\\' }]"
        >
          {{ key }}
        </div>
      </div>
    ...
    <div class="flex justify-center gap-2">
      ...
      <div class="flex flex-col gap-1">
        ...
        <div class="flex gap-1 mb-1">
          ...
          <div
            :class="['key', 'nav-key', { active: pressedKeys.includes('End') }]"
          >
            End
          </div>
          <div
